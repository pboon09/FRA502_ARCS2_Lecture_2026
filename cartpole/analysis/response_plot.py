...
ax1.plot(response.t, response.y[2, :], label="Cart Velocity (m/s)", color="skyblue", linestyle="--")
ax1.set_ylabel("Cart Profile")
ax1.grid(True, linestyle=":", alpha=0.6)
ax1.legend(loc="upper left")
ax1.set_title("Unstable Open-Loop Step Time Response")

ax2.plot(response.t, response.y[1, :], label="Pole Angle (rad)", color="crimson", linewidth=1.8)
